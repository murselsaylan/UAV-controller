...
import time
import sys
from mission_planner import otomatik_mod
...
def mission_planner_thread():
    try:
        otomatik_mod()
    except Exception as e:
        print("Mission Planner hatası:", e)
...
if __name__ == "__main__":
    ...
    # Mission Planner otomatik modunu ayrı bir thread'de başlat
    mp_thread = threading.Thread(target=mission_planner_thread, daemon=True)
    mp_thread.start()
